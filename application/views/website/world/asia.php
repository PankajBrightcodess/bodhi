    ...
    <div class="row text-center">
		...
		<div id="Economy" class="tabcontent" style="border:0px;display:inline;">
				<!--   <h3>Economy</h3> -->
				  <div class="row">
				  	<div class="col-md-7" >
				  		<img src="<?php echo base_url('assets/website/news_image/image76edfde89.jpg');?>" class="img-fluid"><hr>
				  	...
				  	<div class="col-md-5">
				  		<div class="row">
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image878749.jpg');?>" class="img-fluid"></div>
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image9875.jpg');?>" class="img-fluid"></div>
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image8654e765.jpg');?>" class="img-fluid"></div>

				  			<div class="col-md-7 mb-3" style="text-align:justify;"><p>Mere smell of alcohol cannot be construed to mean that person is intoxicated,</p></div>
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image876978.jpg');?>" class="img-fluid"></div>
				  	   </div>
				  	</div>
				  </div><hr>
				  <div class="row">
				  	<div class="col-md-3">
						  ...
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image897978.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image7865677.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image27562r.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image78678.png');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/imagejhg.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image8796.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image98654.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						  </div>
						</div>
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image6787.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						  </div>
						</div>
