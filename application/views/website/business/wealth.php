    ...
    <div class="row text-center">
		...
		<div id="Economy" class="tabcontent" style="border:0px;display:inline;">
				<!--   <h3>Economy</h3> -->
				  <div class="row">
				  	<div class="col-md-7" >
				  		<img src="<?php echo base_url('assets/website/news_image/Er15JbTVkAEYUh9.jpg');?>" class="img-fluid"><hr>
				  	...
				  	<div class="col-md-5">
				  		<div class="row">
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/0820_Financial_Money_Coins_Plants_1200x667.jpg');?>" class="img-fluid"></div>
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/us-dollar-bloomberg-1200.jpg');?>" class="img-fluid"></div>
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/elon-musk.jpg');?>" class="img-fluid"></div>

				  			<div class="col-md-7 mb-3" style="text-align:justify;"><p>Mere smell of alcohol cannot be construed to mean that person is intoxicated,</p></div>
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/cindiafotoIndustry-BBC-HBO-1200.jpg');?>" class="img-fluid"></div>
				  	   </div>
				  	</div>
				  </div><hr>
				  <div class="row">
				  	<div class="col-md-3">
						  ...
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/GettyImages-914861698.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/Stock-Market.png');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/4d3ed6d1-d5ab-40e9-a48e-013ecccefbd1.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/imagrghhg.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/imagf87687.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/Hackers-3.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/290a23df-6de8-4824-8d2c-055be18f5888.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						  </div>
						</div>
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/98705425.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						  </div>
						</div>
