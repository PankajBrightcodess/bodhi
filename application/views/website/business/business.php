    ...
    <div class="row text-center">
        ...
        <div class="col-md-12">
        	...
        	<!-- <div class="row">
				  ...
				  <button class="tablinks" onclick="openCity(event, 'Economy')" style="color:black; float: left; ">Northern</button></div>
				  <div class="col-md-2 col-sm-2 col-lg-2">
				  <button class="tablinks" onclick="openCity(event, 'Markets')" style="color:black; float: left;">Central</button>
				</div>
				<div class="col-md-2 col-sm-2 col-lg-2">
				  <button class="tablinks" onclick="openCity(event, 'Company')" style="color:black; float: left;">Eastern</button>
				</div>
				<div class="col-md-2 col-sm-2 col-lg-2">
				  <button class="tablinks" onclick="openCity(event, 'Startups')" style="color:black; float: left;">North Eastern</button>
				</div>
				<div class="col-md-2 col-sm-2 col-lg-2">
				  <button class="tablinks" onclick="openCity(event, 'Wealth')" style="color:black; float: left;">Southern</button>
				</div>
				<div class="col-md-2 col-sm-2 col-lg-2">
				  <button class="tablinks" onclick="openCity(event, 'Wealth')" style="color:black; float: left;">Western</button>
				</div>
			  </div> -->
			</div>
		...
		<div id="Economy" class="tabcontent" style="border:0px;display:inline;">
				<!--   <h3>Economy</h3> -->
				  <div class="row">
				  	<div class="col-md-7" >
				  		<img src="<?php echo base_url('assets/website/news_image/maxresdefault.jpg');?>" class="img-fluid"><hr>
				  		<p>Sydney Dialogue | Democracies must ensure cryptocurrencies don’t end up in wrong hands: PM Modi,</p>
				  	</div>
				  	<div class="col-md-5">
				  		<div class="row">
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image15ewrofjois.jpg');?>" class="img-fluid"></div>
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/IMAGE8767878.jpg');?>" class="img-fluid"></div>
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image8778.jpg');?>" class="img-fluid"></div>

				  			<div class="col-md-7 mb-3" style="text-align:justify;"><p>Mere smell of alcohol cannot be construed to mean that person is intoxicated,</p></div>
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image898989.jpg');?>" class="img-fluid"></div>
				  	   </div>
				  	</div>
				  </div><hr>
				  <div class="row">
				  	<div class="col-md-3">
						  ...
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image85678.png');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/shubman-gill-fb.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image787897.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image6778.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image7868987.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						  </div>
						</div>
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image89788989.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						  </div>
						</div>
				...
				<div id="Markets" class="tabcontent" style="border:0px;display: none;">
				  ...
				  <div class="row">
				  	<div class="col-md-7" >
				  		<img src="<?php echo base_url('assets/website/news_image/');?>" class="img-fluid">
    ...
    <div class="row text-center">
		...
		<div id="Economy" class="tabcontent" style="border:0px;display:inline;">
				<!--   <h3>Economy</h3> -->
				  <div class="row">
				  	<div class="col-md-7" >
				  		<img src="<?php echo base_url('assets/website/news_image/maxresdefault.jpg');?>" class="img-fluid">
				  		<p><strong>The inevitable shift to electric vehicles is marred with structural and behavioral, </strong></p>
				  	</div>
				  	<div class="col-md-5">
				  		<div class="row">
				  			<div class="col-md-8 mb-3" style="text-align:justify;"><p>Omar Abdullah, Mehbooba Mufti demand impartial probe in Hyderpora encounterOmar Abdullah, </p></div>
				  			<div class="col-md-4 mb-3"><img src="<?php echo base_url('assets/website/news_image/image43.jpg');?>" class="img-fluid"></div>

				  			<div class="col-md-8 mb-3" style="text-align:justify;"><p>Air India sale, Tatas' EV arm keep deal street busy in October with USD 9.2 billion fund flows</p></div>
				  			<div class="col-md-4 mb-3"><img src="<?php echo base_url('assets/website/news_image/image32.png');?>" class="img-fluid"></div>

				  			<div class="col-md-8 mb-3" style="text-align:justify;"><p>Mere smell of alcohol cannot be construed to mean that person is intoxicated,</p></div>
				  			<div class="col-md-4 mb-3"><img src="<?php echo base_url('assets/website/news_image/image19.jpg');?>" class="img-fluid"></div>

				  			<div class="col-md-8 mb-3" style="text-align:justify;"><p>Mere smell of alcohol cannot be construed to mean that person is intoxicated,</p></div>
				  			<div class="col-md-4 mb-3"><img src="<?php echo base_url('assets/website/news_image/image.104.jpg');?>" width="65%" class="img-fluid"></div>
				  	   </div>
				  	</div>
				  </div><hr>
				  <div class="row">
				  	<div class="col-md-3">
						  ...
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image19.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Mere smell of alcohol cannot be construed to mean that person is intoxicated,</p>
						  </div>
						</div>
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style="width: 15rem; height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image33.png');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Air India sale, Tatas' EV arm keep deal street busy in October with USD 9.2 billion fund flows</p>
						  </div>
						</div>
				  	...
				  	<div class="col-md-3">
				  		<div class="card" style="width: 15rem; height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image32.png');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Omar Abdullah, Mehbooba Mufti demand impartial probe in Hyderpora encounterOmar Abdullah,</p>
						  </div>
						</div>
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style="width: 15rem; height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image46.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						  </div>
						</div>
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style="width: 15rem; height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image51.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Strategic Compass': EU sets dates for new military force</p>
						  </div>
						</div>
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style="width: 15rem; height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image48.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Top EU court lashes Hungary over 'Stop Soros' migrant lawTop EU court lashes Hungary over 'Stop Soros'</p>
						  </div>
						</div>
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style="width: 15rem; height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image49.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						  </div>
						</div>
