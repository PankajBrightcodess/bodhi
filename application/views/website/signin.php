<div class="limit" >
    <div class="login-container" >
        <div class="bb-login" style="border-radius: 20px; margin-right: 10px; margin-left: 10px;">
            <form class="bb-form validate-form" method="post" action="<?= base_url('website/logincheck')?>"> <span class="bb-form-title p-b-26"> Welcome </span> <span class="bb-form-title p-b-48"> <img src="<?php echo base_url('assets/images/logo.jpg') ?>" height="150px" width="150px" style="float:center;" style="margin:0px;"></span>
