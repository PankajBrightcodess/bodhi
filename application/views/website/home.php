									...
									if (!empty($gettopnews)) {
                                     ...
                                     <div class="col-md-12">
			                            ...
			                            <div class="card-body text-slug">
												 	  ...
												 	  <a href="<?php echo base_url('website/detailnewsview/'.$val['slug']);?>" style="color: black; text-decoration: none;"><h2 class="card-title" style="word-spacing: -3px;font-family: 'Faustina',sans; font-size: 31px; "><strong><?php echo $val['tittle'] ?></strong></h2></a>
