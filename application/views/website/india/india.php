				...
				<!--   <h3>Economy</h3> -->
				  ...
				  <div class="row">
					  ...
					  <div class="col-md-3 mb-3">
						  ...
						  <a href="<?php echo base_url('website/detailnewsview/' . $val['slug']);?>" style="color: black;"><img width="100%" src="<?php echo base_url();?><?php echo $val['image'] ?>" alt="Card image cap"></a>
