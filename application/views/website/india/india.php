				...
				<!--   <h3>Economy</h3> -->
				  <div class="row top-news">
				  	<div class="col-md-7 main-topnews" >
				  		<?php $j=0; if(!empty($result)){                  
					 	  ...
					 	  <a href="<?php echo base_url('website/detailnewsview/'.$val['slug']);?>" style="color: black;"><h2 class="card-title"><?= $val['tittle'] ?></h2></a>
				  ...
				  <div class="row">
					  ...
					  <div class="col-md-3 mb-3">
						  ...
						  <a href="<?php echo base_url('website/detailnewsview/' . $val['slug']);?>" style="color: black;"><img class="card-img-top" width="100%">  src="<?php echo base_url();?><?php echo $val['image'] ?>" alt="Card image cap"></a>
