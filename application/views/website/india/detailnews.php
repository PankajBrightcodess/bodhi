    ...
    <div class="row text-center" >
		...
		<div id="Economy" class="tabcontent" style="border:0px;display:inline;">
				...
				<div class="container">
                  ...
                  <a target="_blank" href="http://www.facebook.com/sharer.php?s=100&p[summary]=<?= $result['news']; ?>&p[url]=<?= base_url('website/detailnewsview/'.$result['tittle']); ?>" class="social-links-item facebook-icon"></a>
                 ...
                 <!--  <a class="social-links-item mail-icon" title="Gmail" href="#nogo">Email</a> -->
                  ...
                  <a href="whatsapp://send?text=<?= base_url('website/detailnewsview=' . $result['tittle']); ?>" data-action="share/whatsapp/share" target="_blank" class="social-links-item wp-icon" ><!-- <img loading="lazy" src="<?= base_url('assets/website/images/social/7.png'); ?>" alt=""> --></a>
      				...
      				<div class="accordion-body" style="border:1px solid #69c9ff">
        				<p>Support Bodhi Wire with one time or regular contributions to protect independent journalism in the interest of society and the world at large. Contributions from responsible readers like you enable us in covering the world events following the highest standards of journalism. Write to us at office@bodhiwire.com</u>
  			    		...
  			    		<div class="row justify-content-center">
  			    			<div class="col-md-4">
  			    				<p class="btn btn-transparent btn-block" style="background:#e7f1ff;">Once</p>
  			    			</div>
  			    			<div class="col-md-4">
