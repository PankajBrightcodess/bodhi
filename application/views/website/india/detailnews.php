		...
		<div id="Economy" class="tabcontent" style="border:0px;display:inline;">
				...
				<div class="container">
				  <div class="row">
				  	...
				  	<div class="col-md-5">
				  		<div class="row">
				  			<div class="col-md-12"><img src="https://tpc.googlesyndication.com/simgad/6739417430419784616" border="0" width="500" height="600" alt="" class="img_ad"></div>
				  			<div class="col-md-12"><img src="<?php echo base_url('assets/website/news_image/367188368275824930.jpg'); ?>" style="margin-top: 5px;"  border="0" width="500" height="600" alt="" class="img_ad"></div>
