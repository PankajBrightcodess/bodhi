    ...
    <div class="row text-center">
		...
		<div id="Economy" class="tabcontent" style="border:0px;display:inline;">
				<!--   <h3>Economy</h3> -->
				  <div class="row">
				  	<div class="col-md-7" >
				  		<img src="<?php echo base_url('assets/website/news_image/image166.jpg');?>" class="img-fluid"><hr>
				  	...
				  	<div class="col-md-5">
				  		<div class="row">
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image167.jpg');?>" class="img-fluid"></div>
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image168.jpg');?>" class="img-fluid"></div>
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image169.jpg');?>" class="img-fluid"></div>

				  			<div class="col-md-7 mb-3" style="text-align:justify;"><p>Mere smell of alcohol cannot be construed to mean that person is intoxicated,</p></div>
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image170.jpg');?>" class="img-fluid"></div>
				  	   </div>
				  	</div>
				  </div><hr>
				  <div class="row">
				  	<div class="col-md-3">
						  ...
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image171.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image172.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image173.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image174.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image175.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image176.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image177.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						  </div>
						</div>
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card" style=" height: 20rem;">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image178.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						  </div>
						</div>
