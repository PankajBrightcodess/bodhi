    ...
    <div class="row text-center">
		...
		<div id="Economy" class="tabcontent" style="border:0px;display:inline;">
				<!--   <h3>Economy</h3> -->
				  <div class="row">
				  	<div class="col-md-7" >
				  		<img src="<?php echo base_url('assets/website/news_image/image290.jpg');?>" class="img-fluid"><hr>
				  	...
				  	<div class="col-md-5">
				  		<div class="row">
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image201.jpg');?>" class="img-fluid"></div>
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image202.jpeg');?>" class="img-fluid"></div>
				  			...
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image203.jpg');?>" class="img-fluid"></div>

				  			<div class="col-md-7 mb-3" style="text-align:justify;"><p>Mere smell of alcohol cannot be construed to mean that person is intoxicated,</p></div>
				  			<div class="col-md-5 mb-3"><img src="<?php echo base_url('assets/website/news_image/image204.jpg');?>" class="img-fluid"></div>
				  	   </div>
				  	</div>
				  </div><hr>
				  <div class="row">
				  	<div class="col-md-3">
				  		<div class="card">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image206.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image207.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3">
				  		<div class="card">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image208.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image209.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image210.jpeg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image211.jpg');?>" alt="Card image cap">
						  <div class="card-body">
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image212.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						  </div>
						</div>
				  	...
				  	<div class="col-md-3 mb-3">
				  		<div class="card">
						  <img class="card-img-top" src="<?php echo base_url('assets/website/news_image/image213.jpg');?>" alt="Card image cap">
						  <div class="card-body">
						    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						  </div>
						</div>
